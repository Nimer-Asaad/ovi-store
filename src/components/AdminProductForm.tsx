    ...
    <form className="grid gap-6">
      <section className="surface-panel grid gap-4 p-6 md:grid-cols-2">
        ...
        <label className="grid gap-2 text-sm font-black text-slate-700 md:col-span-2">
          الوصف
          <textarea defaultValue={product?.description} className="form-control min-h-28 p-3" />
        </label>
      </section>
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        <button type="button" className="btn-secondary">حفظ المنتج</button>
        <button type="button" className="btn-ghost hover:border-rose-300 hover:text-rose-700">حذف المنتج</button>
      </div>
    </form>
  );
}
